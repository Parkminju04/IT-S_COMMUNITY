...
class MyAccountManager(BaseUserManager):
    ...
    def create_user(self, id, username, std_id, birth, tel, email, github, password=None):
        if not id:
    ...
    # 관리자 User 생성
    def create_superuser(self, id, username, std_id, birth, tel, email, github, password, **extra_fields):
...
class User(models.Model):
    ...
    REQUIRED_FIELDS = ['username', 'std_id', 'birth', 'tel', 'email', 'github']  # 필수 작성 필드
